    ...
    fun `when searchMovie is called, should parse json response`() {
        ...
        val expectedMovies = listOf(
            ...
            MovieDto(
                ...
                overview = "Following their explosive showdown, Godzilla and Kong must reunite against a colossal " +
                    "undiscovered threat hidden within our world, challenging their very existence – and our own.",
                popularity = 1852.222,
